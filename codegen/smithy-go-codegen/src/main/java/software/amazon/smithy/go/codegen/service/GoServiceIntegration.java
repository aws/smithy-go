...
@SmithyUnstableApi
public interface GoServiceIntegration extends SmithyIntegration<GoSettings, GoWriter, GoCodegenContext> {
    /**
    ...
    default GoSettings.ArtifactType getArtifactType() {
     ...
     */
    default SymbolProvider decorateSymbolProvider(GoSettings settings, Model model, SymbolProvider symbolProvider) {
    ...
    default void onShapeWriterUse(
            GoSettings settings, Model model, SymbolProvider symbolProvider, GoWriter writer, Shape definedShape
    ) {
    }
     ...
     * @param model Model to generate from.
     * @param symbolProvider Symbol provider used for codegen.
     * @param delegator Writer delegator used to manage writer for the file.
     */
    default void writeAdditionalFiles(
            GoSettings settings, Model model, SymbolProvider symbolProvider, WriterDelegator<GoWriter> delegator
    ) {
    }
