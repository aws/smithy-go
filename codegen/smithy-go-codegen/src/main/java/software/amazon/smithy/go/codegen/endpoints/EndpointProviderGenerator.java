 ...
 */
 ...
 public final class EndpointProviderGenerator {
     ...
     private EndpointProviderGenerator(Builder builder) {
     ...
     private String nameForExpr(Expression expr) {
     ...
     private GoWriter.Writable generateEndpoint(Endpoint endpoint, Scope scope) {
         return goTemplate("""
                 ...
                 commonCodegenArgs,
                 MapUtils.of(
                         "url", new ExpressionGenerator(scope).generate(endpoint.getUrl()),
     ...
     class RuleVisitor implements RuleValueVisitor<GoWriter.Writable> {
         ...
         public GoWriter.Writable visitErrorRule(Expression errorExpr) {
             return goTemplate("""
                     ...
                     commonCodegenArgs,
                     MapUtils.of(
                             "errorExpr", new ExpressionGenerator(scope).generate(errorExpr)
                     ));
         }
     ...
     public static final class Builder implements SmithyBuilder<EndpointProviderGenerator> {
         ...
         @Override
         public EndpointProviderGenerator build() {
             return new EndpointProviderGenerator(this);
         }
     }
 }
