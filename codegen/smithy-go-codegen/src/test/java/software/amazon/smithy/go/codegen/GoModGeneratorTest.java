...
public class GoModGeneratorTest {
    private static final Logger LOGGER = Logger.getLogger(GoModGeneratorTest.class.getName());

    @Test
    public void testGoModGenerator() {
        ...
        // Assert
        assertThat(manifest.hasFile("go.mod"),
            is(true));
    }
